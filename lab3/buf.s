...
08048dc0 <fizz>:
 ...
 8048dc3:	53                   	push   %ebx
 8048dc4:	83 ec 14             	sub    $0x14,%esp # 0x14
 8048dc7:	8b 5d 08             	mov    0x8(%ebp),%ebx # [b] = [p+0x8]
 
 8048dca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp) # [s] = 0x1
 8048dd1:	e8 ca fb ff ff       	call   80489a0 <entry_check>
 8048dd6:	3b 1d cc a1 04 08    	cmp    0x804a1cc,%ebx # b cmp 0x804a1cc

 8048ddc:	74 22                	je     8048e00 <fizz+0x40>
 8048dde:	89 5c 24 04          	mov    %ebx,0x4(%esp)
 8048de2:	c7 04 24 98 98 04 08 	movl   $0x8049898,(%esp) # "Misfire: You called fizz(0x%x)\n"
 ...
 8048e04:	c7 04 24 29 9a 04 08 	movl   $0x8049a29,(%esp) # "Fizz!: You called fizz(0x%x)\n"
...
08048fe0 <getbuf>:
 ...
 8048fe6:	8d 45 f4             	lea    -0xc(%ebp),%eax # 读取0xc个字节(buf) 希望读出smoke的地址
