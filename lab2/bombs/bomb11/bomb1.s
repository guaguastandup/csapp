...
# [p - 0xc]里面存放的是返回值
 ...
 8048dba:	8b 45 08             	mov    0x8(%ebp),%eax		# a = [p + 0x8] = 134522416 = 0x804a630, 也就是输入的值	
 8048dbd:	89 45 f0             	mov    %eax,-0x10(%ebp)		# [p - 0x10] = a = 134522416
 8048dc0:	8b 45 08             	mov    0x8(%ebp),%eax		# a = [p + 0x8]= 134522416
 8048dc3:	89 45 f0             	mov    %eax,-0x10(%ebp)		# [p - 0x10] = a = 134522416

 8048dc6:	8b 45 08             	mov    0x8(%ebp),%eax		# a = [p + 0x8] =  134522416
 8048dc9:	8b 40 08             	mov    0x8(%eax),%eax		# a = [a + 0x8] =  134522404 = 134522416 - 12
 b 8048dcc:	89 45 f4             	mov    %eax,-0xc(%ebp)		# [p - 0xc] = a = 134522404
 b 8048dcf:	8b 45 f0             	mov    -0x10(%ebp),%eax		# a = [p - 0x10] = 
 8048dd2:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)		# [a + 0x8] = 0
...
08048e48 <phase_6>:
 ...
 8048e4e:	c7 45 f8 30 a6 04 08 	movl   $0x804a630,-0x8(%ebp) 	# 0x804a630 = 134522416
 # 调用atoi函数
 8048e55:	8b 45 08             	mov    0x8(%ebp),%eax	# 此处存的是输入的字符串, 应该表示一个地址
 # 8048e58:	89 04 24             	mov    %eax,(%esp) 	# skip
 8048e5b:	e8 f8 f9 ff ff       	call   8048858 <atoi@plt>
 8048e60:	89 45 f4             	mov    %eax,-0xc(%ebp) 	# [p - 0xc] 存放返回值, 是刚刚输入的数字

 8048e63:	8b 45 f8             	mov    -0x8(%ebp),%eax	# a = [p - 0x8] = $0x804a630
 8048e66:	89 04 24             	mov    %eax,(%esp)		# 将[p - 0x8] = $0x804a630作为参数放入func6中
 8048e69:	e8 46 ff ff ff       	call   8048db4 <fun6>
 
 8048e6e:	89 45 f8             	mov    %eax,-0x8(%ebp)	# [p - 0x8] = a 将func6的返回值放入[p - 0x8]
 8048e71:	8b 45 f8             	mov    -0x8(%ebp),%eax	# a = [p - 0x8] 
 8048e74:	89 45 fc             	mov    %eax,-0x4(%ebp)	# [p - 0x4] = a	
# 目前[p - 0x4]和[p - 0x8]里面存放的都是func6的返回值
# for(i = 1; i!=5; i++) {
	8048e77:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)	# [p - 0x10] = 1
	8048e7e:	eb 0c                	jmp    8048e8c <phase_6+0x44>

	8048e80:	8b 45 fc             	mov    -0x4(%ebp),%eax	# a = [p - 0x4], a.1 是一个地址
	8048e83:	8b 40 08             	mov    0x8(%eax),%eax	# a = [a + 0x8], a.2 是一个地址
	8048e86:	89 45 fc             	mov    %eax,-0x4(%ebp)	# [p - 0x4] = a, a.2 是一个地址
	8048e89:	ff 45 f0             	incl   -0x10(%ebp)
	# 额好像[p - 0x8]没什么用
	8048e8c:	83 7d f0 05          	cmpl   $0x5,-0x10(%ebp)	# [p - 0x10] comp 5
	8048e90:	75 ee                	jne    8048e80 <phase_6+0x38>
 # }
 8048e92:	8b 45 fc             	mov    -0x4(%ebp),%eax # a = [p - 0x4]
 8048e95:	8b 00                	mov    (%eax),%eax	   # a = v[a]
 8048e97:	3b 45 f4             	cmp    -0xc(%ebp),%eax # 716
